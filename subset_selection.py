...
def subset_selection(y):
    ...
    """ sel4 = RFECV(clf_NB, min_features_to_select=1, step=1, importance_getter=nb_ig)
...
RFE_df_binary, cv_results_binary = subset_selection(train_y2)
RFE_df_multi, cv_results_multi = subset_selection(train_y)

""" print(RFE_df_binary)
print(RFE_df_multi)

LR1_results = cv_results_binary[0].iloc[:40]
LR2_results = cv_results_binary[1].iloc[:40]
DT_results = cv_results_binary[2].iloc[:40]

LR1_results2 = cv_results_multi[0].iloc[:40]
LR2_results2 = cv_results_multi[1].iloc[:40]
DT_results2 = cv_results_multi[2].iloc[:40]
